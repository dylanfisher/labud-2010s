Rails.application.configure do
  ...
  # config.action_controller.asset_host = Rails.application.credentials.dig(:asset_host)
  ...
  # config.active_job.queue_name_prefix = "labud_2010s_production"
  ...
  config.paperclip_defaults = {
    ...
    s3_protocol: :https,
    s3_host_alias: 's3.amazonaws.com/labud-2010s.dylanfisher.com'
